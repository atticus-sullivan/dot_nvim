...
" label needs to be matched *after* operators
syn match   gasLabel		/\.L[A-Za-z0-9]\+/ "local label declaration
syn match   gasLabel		/^\s*\.L[A-Za-z0-9]\+:/ "local label usage
...
highlight gasLabel ctermfg=5 cterm=bold
highlight keyword  ctermfg=4 cterm=bold
highlight Constant ctermfg=5
highlight gasRegister ctermfg=1
